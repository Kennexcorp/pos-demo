...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_6__.defineComponent)({
  ...
  setup: function setup() {
    ...
    var printItems = function printItems() {
      print(formatForPrinting(filteredSales.value), (0,_home_kennexcorp_Documents_Projects_PosEatery_backend_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__.default)({
        name: user.name
